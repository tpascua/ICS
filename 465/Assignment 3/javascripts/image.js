...
(function() {
  ...
  Media = (function() {
    ...
    Media.prototype.border = function(border_) {
      if (arguments.length === 0) {
        return this.border_;
      }
    ...
    Media.prototype.margin = function(margin_) {
      if (arguments.length === 0) {
        return this.margin_;
      }
  ...
  Canvas = (function() {
    ...
    function Canvas(id) {
      var canvas;
      canvas = $("#" + id).get(0);
      supported = canvas && canvas.getContext !== null;
      if (supported) {
        this.context = canvas.getContext('2d');
      }
    }

    Canvas.prototype.line = function(from, to, stroke) {
      if (!supported) {
        return;
      }
      if (!stroke) {
  ...
  $(function() {
    var dom, id, ids, image, stickman, _i, _len;
    dom = {};
    ids = ['image', 'top', 'left', 'position', 'width', 'height', 'resize', 'link', 'border_width', 'border_color', 'set_border', 'get_border', 'margin', 'set_margin', 'padding', 'set_padding', 'set_link', 'stickman'];
    ...
    return $().ready(function() {
      return new Canvas('stickman').line({
        x: 150,
        y: 1
      }, {
        x: 69,
